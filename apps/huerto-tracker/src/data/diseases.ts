...
export const DISEASES: DiseaseInfo[] = [
  {
    ...
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Downy_mildew_on_grape_leaf.jpg?width=640',
    treatments: [
  ...
  },
  {
    ...
    emoji: '🤍',
    severity: 2,
    affectedCrops: ['calabacin', 'pepino', 'tomate', 'pimiento', 'judia-verde'],
    ...
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Powdery_mildew_on_a_cucumber_leaf.jpg?width=640',
    treatments: [
  ...
  },
  {
    ...
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Botrytis_cinerea_botrytis_bunch_rot.jpg?width=640',
    treatments: [
  ...
  },
  {
    ...
    emoji: '🐜',
    severity: 2,
    affectedCrops: ['tomate', 'pimiento', 'judia-verde', 'haba', 'lechuga', 'col', 'brocoli', 'coliflor'],
    ...
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Aphids_on_rose.jpg?width=640',
    treatments: [
  ...
  },
  {
    ...
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Bemisia_tabaci_-_common_names_and_host_plants.jpg?width=640',
    treatments: [
  ...
  },
  {
    ...
    emoji: '🕷️',
    severity: 3,
    affectedCrops: ['tomate', 'pimiento', 'pepino', 'fresa', 'judia-verde'],
    ...
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Tetranychus_urticae_with_silk_threads.jpg?width=640',
    treatments: [
  ...
  },
  {
    ...
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Thrips.jpg?width=640',
    treatments: [
  ...
  },
  {
    ...
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Iron_deficiency_in_tree.jpg?width=640',
    treatments: [
  ...
  },
  {
    ...
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Blossom_end_rot_on_a_green_tomato.jpg?width=640',
    treatments: [
